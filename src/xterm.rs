...
pub struct Theme {
    ...
    #[wasm_bindgen(js_name = "brightBlack")]
    pub bright_black: Option<Str>,

    /// ANSI bright blue (eg. `\x1b[1;34m`)
    #[wasm_bindgen(js_name = "brightBlue")]
    pub bright_blue: Option<Str>,

    /// ANSI bright cyan (eg. `\x1b[1;36m`)
    #[wasm_bindgen(js_name = "brightCyan")]
    pub bright_cyan: Option<Str>,

    /// ANSI bright green (eg. `\x1b[1;32m`)
    #[wasm_bindgen(js_name = "brightGreen")]
    pub bright_green: Option<Str>,

    /// ANSI bright magenta (eg. `\x1b[1;35m`)
    #[wasm_bindgen(js_name = "brightMagenta")]
    pub bright_magenta: Option<Str>,

    /// ANSI bright red (eg. `\x1b[1;31m`)
    #[wasm_bindgen(js_name = "brightRed")]
    pub bright_red: Option<Str>,

    /// ANSI bright white (eg. `\x1b[1;37m`)
    #[wasm_bindgen(js_name = "brightWhite")]
    pub bright_white: Option<Str>,

    /// ANSI bright yellow (eg. `\x1b[1;33m`)
    #[wasm_bindgen(js_name = "brightYellow")]
    pub bright_yellow: Option<Str>,
    ...
    #[wasm_bindgen(js_name = "cursorAccent")]
    pub cursor_accent: Option<Str>,
    ...
    pub foreground: Option<Str>,

    /// ANSI green (eg. `\x1b[32m`)
    #[wasm_bindgen(js_name = "green")]
    pub green: Option<Str>,

    /// ANSI magenta (eg. `\x1b[35m`)
    #[wasm_bindgen(js_name = "magenta")]
    pub magenta: Option<Str>,
    ...
    #[wasm_bindgen(js_name = "selection")]
    pub selection: Option<Str>,

    /// ANSI white (eg. `\x1b[37m`)
    #[wasm_bindgen(js_name = "white")]
    pub white: Option<Str>,
